...
# Bauskript fuer die ausgelieferte Fassung v1.3.1 (visales.de).
...
#   python3 deploy/build-visales-v1-3-1.py
# Erzeugt deploy/visales/usdconfig-demo-v1-3-1.html aus rules-demo.html.
...
SRC = 'rules-demo.html'
DST = 'deploy/visales/usdconfig-demo-v1-3-1.html'
...
rep('<link rel="canonical" href="https://kopfkinok3.github.io/USDconfig-demo-player/rules-demo.html">',
    '<link rel="canonical" href="https://visales.de/usdconfig-demo-v1-3-1.html">')
...
rep('<meta property="og:url" content="https://kopfkinok3.github.io/USDconfig-demo-player/rules-demo.html">',
    '<meta property="og:url" content="https://visales.de/usdconfig-demo-v1-3-1.html">')
...
rep('<meta name="twitter:card" content="summary_large_image">\n',
    ...
    '     uebereinstimmen. -->\n'
    '<meta name="usdconfig-version" content="1.3.1">\n')
